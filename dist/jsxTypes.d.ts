...
declare global {
    namespace JSX {
        ...
        interface TouchBarButtonElement<T> extends TouchBarRendererElement<T, Text> {
            onClick?: () => void;
        ...
        interface TouchBarScrubItem<T> extends TouchBarRendererElement<T, Text> {
            icon?: NativeImage | null;
        }
        interface TouchBarSegment<T> extends TouchBarRendererElement<T, Text> {
            disabled?: boolean;
            icon?: NativeImage | null;
        }
        ...
        interface TouchBarSlider<T> extends TouchBarRendererElement<T, Text> {
            debounceTime?: number;
        ...
        interface TouchBarLabel<T> extends TouchBarRendererElement<T, Text> {
            color?: string | null;
        }
        ...
        type PopoverValidElements = (Element | Element[] | TextElement | ButtonElement | ColorPickerElement | LabelElement | SegmentedControlElement | SliderElement | SpacerElement | ScrubberElement)[];
