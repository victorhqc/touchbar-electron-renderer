...
var TouchBarButton = /** @class */ (function () {
    ...
    TouchBarButton.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { label: this.children && this.children.createInstance(), click: onClick });
    };
...
var TouchBarColorPicker = /** @class */ (function () {
    ...
    TouchBarColorPicker.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { change: onChange, selectedColor: selected, availableColors: this.children
                .map(function (child) { return child.createInstance(); })
                .filter(isTruthy) });
    };
...
var TouchBarLabel = /** @class */ (function () {
    ...
    TouchBarLabel.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { textColor: color, label: (this.children && this.children.createInstance()) || '' });
    };
...
var TouchBarPopover = /** @class */ (function () {
    ...
    TouchBarPopover.prototype.updateInstance = function () {
        var _this = this;
        var isRerenderNeeded = false;
        var items = this.getItems(false);
        var args = __assign(__assign({}, this.getNativeArgs()), { items: items });
        // Update instance.
        Object.keys(args).forEach(function (key) {
            if (key === 'items') {
                return;
    ...
    TouchBarPopover.prototype.createInstance = function () {
        ...
        if (!NativeTouchBar)
            return null;
        this.instance = new NativeTouchBar.TouchBarPopover(__assign(__assign({}, args), { items: new NativeTouchBar({ items: items }) }));
        this.didChildrenChange = false;
        return this.instance;
    };
...
var TouchBarScrubItem = /** @class */ (function () {
    ...
    TouchBarScrubItem.prototype.getNativeArgs = function () {
        return __assign(__assign(__assign({}, this.props), cleanReactProps()), { label: this.children && this.children.createInstance() });
    };
...
var TouchBarSegment = /** @class */ (function () {
    ...
    TouchBarSegment.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { enabled: disabled ? false : true, label: this.children && this.children.createInstance() });
    };
...
var TouchBarSegmentedControl = /** @class */ (function () {
    ...
    TouchBarSegmentedControl.prototype.getNativeArgs = function (buildItems) {
        if (buildItems === void 0) { buildItems = true; }
        var _a = this.props, onChange = _a.onChange, selected = _a.selected, props = __rest(_a, ["onChange", "selected"]);
        return __assign(__assign(__assign({}, props), cleanReactProps()), { change: onChange || nop$1, selectedIndex: selected, segments: this.getSegments(buildItems) });
    };
...
var TouchBarSlider = /** @class */ (function () {
    ...
    TouchBarSlider.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { label: this.children && this.children.createInstance(), 
            // If not debounced, it causes serious performance issues
...
var TouchBarSpacer = /** @class */ (function () {
    ...
    TouchBarSpacer.prototype.getNativeArgs = function () {
        ...
        return __assign(__assign(__assign({}, props), cleanReactProps()), { size: sizeByProps });
    };
...
exports.ReactTouchBar = TouchBarRenderer;
exports.TouchBar = TouchBar;
exports.TouchBarButton = TouchBarButton;
exports.TouchBarColor = TouchBarColor;
exports.TouchBarColorPicker = TouchBarColorPicker;
exports.TouchBarGroup = TouchBarGroup;
exports.TouchBarLabel = TouchBarLabel;
exports.TouchBarPopover = TouchBarPopover;
exports.TouchBarScrubItem = TouchBarScrubItem;
exports.TouchBarScrubber = TouchBarScrubber;
exports.TouchBarSegment = TouchBarSegment;
exports.TouchBarSegmentedControl = TouchBarSegmentedControl;
exports.TouchBarSlider = TouchBarSlider;
exports.TouchBarSpacer = TouchBarSpacer;
exports.TouchBarText = TouchBarText;
